...
const apiBaseURL = "https://encouraging-spurious-stomach.glitch.me/api/bookmarks";
...
function webAPI_GET_ETAG(successCallBack, errorCallBack) 
{ 
    $.ajax({ url: apiBaseURL, type: 'HEAD', contentType:'text/plain', complete: function(request) 
        { 
        ...
        error: function(jqXHR, textStatus, errorThrown) 
        { 
            errorCallBack(jqXHR.status); console.log("webAPI_GET_ETAG - error"); 
        } 
    }); 
}
